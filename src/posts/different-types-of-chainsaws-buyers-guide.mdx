...
beforebody: >-
  ...
  To better understand the origins of the mighty chainsaw let’s delve a bit deeper into its history. German surgeon Bernard Heine first made the device in 1830 and named it the [Osteotome](https://en.wikipedia.org/wiki/Chainsaw){:target="_blank"}
